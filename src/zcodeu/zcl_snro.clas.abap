...
*          EXPORTING
*            interval  = VALUE #( ( nrrangenr = '01' fromnumber = '00001' tonumber = '99999' procind = 'I' ) )
*            object    = 'ZGATE_1'
*          IMPORTING
*            error     = DATA(ld_error)
...
**********************************************************************
    TRY.
        cl_numberrange_intervals=>update(
          EXPORTING
            interval = VALUE #( ( nrrangenr = '01' fromnumber = '00001' tonumber = '99999' procind = 'U' ) )
            object   = 'ZGATE_1'
*           subobject =
*           option   =
*      IMPORTING
...
** Delete tables data
**********************************************************************
*    delete  from zjtb_student_1.
*    delete from zjtb_dstudent_1.
*    delete from zjtb_academic_1.
*    delete from zjtb_dacademic_1.
**********************************************************************
**  GET NUMBER
**********************************************************************
*    TRY.
